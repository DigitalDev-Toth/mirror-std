            ...
            var workspace = '<div class="row">'
                                +'<div class="col-xs-2 center-block">'
                                    +'<div id="toolbox" class="text-center">'
                                        ...
                                        +'<div id="separator" style="width: 100%; height: 20px; background-color: rgb(68, 68, 68); border-top: 5px solid rgb(68, 68, 68); border-bottom: 5px solid rgb(68, 68, 68);"></div>'
                                        +'<button id="close" type="button" class="btn btn-default btn-size" title="'+ lang.buttonClose +'" data-toggle="modal"><span class="glyphicon glyphicon-remove"></span></button>'
                                        +'<button id="send" type="button" class="btn btn-default btn-size" title="'+ lang.buttonSend +'" data-toggle="modal" data-target="#reportModal"><span class="glyphicon glyphicon-send"></span></button>'
                                        +'<div id="separator" style="width: 100%; height: 20px; background-color: rgb(68, 68, 68); border-top: 5px solid rgb(68, 68, 68); border-bottom: 5px solid rgb(68, 68, 68);"></div>'
